...
//#define MOUSEKEY_MAX_SPEED 7 //5 0k bajar //max speed en la que se detiene la aceleracion
//#define MOUSEKEY_TIME_TO_MAX 30 //150 100 0k
#define MOUSEKEY_MOVE_DELTA 1 //5 2 0k mas lento
//#define MOUSEKEY_INTERVAL 18 //5 ok
