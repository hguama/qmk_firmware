...
#define MOUSEKEY_MAX_SPEED 4 //5 0k bajar //max speed en la que se detiene la aceleracion
#define MOUSEKEY_TIME_TO_MAX 130 //150 100 0k
#define MOUSEKEY_MOVE_DELTA 2 //5 2 0k mas lento
#define MOUSEKEY_INTERVAL 2 //5 ok
